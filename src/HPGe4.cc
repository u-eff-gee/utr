...
HPGe4::HPGe4(G4String Detector_Name) {
	...
	G4double Detector_Radius = 68. * mm / 2.; // Brent Fallin's suggestion, not
	                                          // in the ORTEC data sheet.
	                                          // Detector 1 was reconditioned.
	G4double Detector_Length = 80.5 * mm;   // Brent Fallin's suggestion, not in
	...
	HPGe4_Logical = new G4LogicalVolume(Mother_Solid, Mother_Material,
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Length / 2 -
	                                               EndCap_Window),
	                  EndCap_Logical, "EndCap", HPGe4_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window / 2),
	                  EndCap_Window_Logical, "EndCap_Window", HPGe4_Logical,
	                  false, 0);
	...
	new G4PVPlacement(
	    ...
	    MountCup_Logical, "MountCup_Wall", HPGe4_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., -Length / 2 + MountCup_Base / 2),
	                  MountCup_Base_Logical, "MountCupBase", HPGe4_Logical,
	                  false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window -
	                                               ...
	                                               MountCup_Wall / 2),
	                  MountCup_Face_Logical, "MountCup_Face", HPGe4_Logical,
	                  false, 0);
	...
	new G4PVPlacement(
	    ...
	    ColdFinger_Logical, "ColdFinger", HPGe4_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window -
	                  ...
	                  Crystal_Logical, "Crystal", HPGe4_Logical, false, 0);
}
