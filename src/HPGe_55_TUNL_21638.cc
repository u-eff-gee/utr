...
HPGe_55_TUNL_21638::HPGe_55_TUNL_21638(G4String Detector_Name) {
	...
	G4double Detector_Length = 84.4 * mm;
	G4double Detector_End_Radius = 8. * mm; // (J)
	G4double Hole_Radius = 9.2 * mm / 2.;
	G4double Hole_Depth = 76.3 * mm;
	G4double Hole_Bottom_Radius = Hole_Radius;

	//G4double MountCup_Length = 105. * mm;      // (A)
	G4double MountCup_Length = 6.5 * inch;      // Including the case for the electronics
	...
	G4double Connection_Length = 1.5*inch;
	G4double Connection_Radius = 0.75*inch; // Estimated

	// Dewar dimensions
	
	G4double Dewar_Length = 12.5*inch;
	G4double Dewar_Outer_Radius = 4.5*inch;
	...
	HPGe_55_TUNL_21638_Logical = new G4LogicalVolume(Mother_Solid, Mother_Material,
	                                       "Mother_Logical", 0, 0, 0);

	HPGe_55_TUNL_21638_Logical->SetVisAttributes(G4VisAttributes::GetInvisible());
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Length / 2 -
	                                               EndCap_Window),
	                  EndCap_Logical, "EndCap", HPGe_55_TUNL_21638_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window / 2),
	                  EndCap_Window_Logical, "EndCap_Window", HPGe_55_TUNL_21638_Logical,
	                  false, 0);
	...
	new G4PVPlacement(
	    ...
	    MountCup_Logical, "MountCup_Wall", HPGe_55_TUNL_21638_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5 - EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Wall + MountCup_Base*0.5),
	                  MountCup_Base_Logical, "MountCupBase", HPGe_55_TUNL_21638_Logical,
	                  false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window -
	                                               ...
	                                               MountCup_Wall / 2),
	                  MountCup_Face_Logical, "MountCup_Face", HPGe_55_TUNL_21638_Logical,
	                  false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length * 0.5 - EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length),
	                  ColdFinger_Logical, "ColdFinger", HPGe_55_TUNL_21638_Logical, false,
	                  0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length * 0.5 - EndCap_Window -
	                                               ...
	                                               MountCup_Wall -
	                                               Detector_Length),
	                  Crystal_Logical, "Crystal", HPGe_55_TUNL_21638_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length*0.5), Connection_Logical, "Connection", HPGe_55_TUNL_21638_Logical, false, 0, false);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length - Dewar_Wall_Thickness*0.5), Dewar_Lid_Logical, "Dewar_Lid_1", HPGe_55_TUNL_21638_Logical, false, 0, false);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length - Dewar_Length*0.5), Dewar_Wall_Logical, "Dewar_Wall", HPGe_55_TUNL_21638_Logical, false, 0, false);

	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length - Dewar_Length + Dewar_Wall_Thickness*0.5), Dewar_Lid_Logical, "Dewar_Lid_2", HPGe_55_TUNL_21638_Logical, false, 0, false);
}
