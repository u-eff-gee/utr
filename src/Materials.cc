...
void Materials::ConstructMaterials(){
 ...
 // for example isotopically enriched materials or materials with a non-standard density.
...
/******************************************************/
  	...
  	G4Isotope* Ti50 = new G4Isotope(name="50Ti", z=22, n=28, a=49.945791*g/mole);
  	G4Isotope* Ti49 = new G4Isotope(name="49Ti", z=22, n=27, a=48.947870*g/mole);
  	G4Isotope* Ti48 = new G4Isotope(name="48Ti", z=22, n=26, a=47.947946*g/mole);
  	G4Isotope* Ti47 = new G4Isotope(name="47Ti", z=22, n=25, a=46.951763*g/mole);
  	G4Isotope* Ti46 = new G4Isotope(name="46Ti", z=22, n=24, a=45.952631*g/mole);
  
  	G4Element* enriched_Ti = new G4Element(name="enriched Ti", symbol="Ti", ncomponents=5);
  	...
  	target_TiO2 = new G4Material(name="enriched Ti", density=4.*g/cm3, ncomponents=2);
...
// Brillance 380 from Enrique Nacher (Santiago)
    	LaBr3Ce = new G4Material("Brillance380",density= 5.08*g/cm3, ncomponents=3);
...
// Brillance350 from Enrique Nacher (Santiago)
	LaCl3Ce = new G4Material("Brillance350",density=3.85*g/cm3, ncomponents=3);
