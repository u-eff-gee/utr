...
HPGe2_55::HPGe2_55(G4String Detector_Name) {
	...
	HPGe2_55_Logical = new G4LogicalVolume(Mother_Solid, Mother_Material,
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Length / 2 -
	                                               EndCap_Window),
	                  EndCap_Logical, "EndCap", HPGe2_55_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window / 2),
	                  EndCap_Window_Logical, "EndCap_Window", HPGe2_55_Logical,
	                  false, 0);
	...
	new G4PVPlacement(
	    ...
	    MountCup_Logical, "MountCup_Wall", HPGe2_55_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., -Length / 2 + MountCup_Base / 2),
	                  MountCup_Base_Logical, "MountCupBase", HPGe2_55_Logical,
	                  false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window -
	                                               ...
	                                               MountCup_Wall / 2),
	                  MountCup_Face_Logical, "MountCup_Face", HPGe2_55_Logical,
	                  false, 0);
	...
	new G4PVPlacement(
	    ...
	    ColdFinger_Logical, "ColdFinger", HPGe2_55_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window -
	                  ...
	                  Crystal_Logical, "Crystal", HPGe2_55_Logical, false, 0);
}
