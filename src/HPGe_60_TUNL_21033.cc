...
HPGe_60_TUNL_21033::HPGe_60_TUNL_21033(G4String Detector_Name) {
	...
	G4double Detector_Radius = 68. * mm / 2.;	
	G4double Detector_Length = 80. * mm;
	...
	HPGe_60_TUNL_21033_Logical = new G4LogicalVolume(Mother_Solid, Mother_Material,
	                                    "Mother_Logical", 0, 0, 0);

	HPGe_60_TUNL_21033_Logical->SetVisAttributes(G4VisAttributes::GetInvisible());
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Length / 2 -
	                                               EndCap_Window),
	                  EndCap_Logical, "EndCap", HPGe_60_TUNL_21033_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window / 2),
	                  EndCap_Window_Logical, "EndCap_Window", HPGe_60_TUNL_21033_Logical,
	                  false, 0);
	...
	new G4PVPlacement(
	    ...
	    MountCup_Logical, "MountCup_Wall", HPGe_60_TUNL_21033_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5 - EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Wall + MountCup_Base*0.5),
	                  MountCup_Base_Logical, "MountCupBase", HPGe_60_TUNL_21033_Logical,
	                  false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length / 2 - EndCap_Window -
	                                               ...
	                                               MountCup_Wall / 2),
	                  MountCup_Face_Logical, "MountCup_Face", HPGe_60_TUNL_21033_Logical,
	                  false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length * 0.5 - EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length),
	                  ColdFinger_Logical, "ColdFinger", HPGe_60_TUNL_21033_Logical, false,
	                  0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length * 0.5 - EndCap_Window -
	                                               ...
	                                               MountCup_Wall -
	                                               Detector_Length),
	                  Crystal_Logical, "Crystal", HPGe_60_TUNL_21033_Logical, false, 0);
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length*0.5), Connection_Logical, "Connection", HPGe_60_TUNL_21033_Logical, false, 0, false);
	...
	new G4PVPlacement(0, G4ThreeVector(0., Dewar_Offset_From_Center, Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length - Dewar_Wall_Thickness*0.5), Dewar_Lid_Logical, "Dewar_Lid_1", HPGe_60_TUNL_21033_Logical, false, 0, false);
	...
	new G4PVPlacement(0, G4ThreeVector(0., Dewar_Offset_From_Center, Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length - Dewar_Length*0.5), Dewar_Wall_Logical, "Dewar_Wall", HPGe_60_TUNL_21033_Logical, false, 0, false);

	new G4PVPlacement(0, G4ThreeVector(0., Dewar_Offset_From_Center, Length*0.5- EndCap_Window - End_Cap_To_Crystal_Gap - MountCup_Length - Connection_Length - Dewar_Length + Dewar_Wall_Thickness*0.5), Dewar_Lid_Logical, "Dewar_Lid_2", HPGe_60_TUNL_21033_Logical, false, 0, false);
}
