...
Filter_Case::Filter_Case(G4LogicalVolume *World_Logical, G4String name):
	World_Log(World_Logical),
...
void Filter_Case::Construct_Ring(G4ThreeVector global_coordinates, G4double theta,
	...
	filter_case_ring_logical->SetVisAttributes(new G4VisAttributes(G4Color::Yellow()));
