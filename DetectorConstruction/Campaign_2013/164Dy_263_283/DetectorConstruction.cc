...
G4VPhysicalVolume *DetectorConstruction::Construct() {
  ...
  new G4PVPlacement(
      rotateG3Target1,
      G4ThreeVector(0., 0., -BeamTube_Length_Downstream + BeamTube_Length * 0.5 + dy164_Target->Get_Thickness() / 2.),
  ...
  new G4PVPlacement(
      rotateG3Target2,
      G4ThreeVector(0., 0., -BeamTube_Length_Downstream + BeamTube_Length * 0.5 - dy164_2O3_Target->Get_Thickness() / 2.),
