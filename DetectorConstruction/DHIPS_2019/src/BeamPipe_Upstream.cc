...
void BeamPipe_Upstream::Construct(G4ThreeVector global_coordinates,G4double relative_density)
{
	...
	new G4PVPlacement(0, G4ThreeVector(0., 0., beamPipe_Large_Radius_Length*0.5), beamPipe_Large_Radius_Logical, "beamPipe_Large_Radius", beampipe_upstream_Mother_Logical, false, 0);
