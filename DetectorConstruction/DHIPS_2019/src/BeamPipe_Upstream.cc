...
void BeamPipe_Upstream::Construct(G4ThreeVector global_coordinates,G4double relative_density)
{
	...
	new G4PVPlacement(0, global_coordinates+G4ThreeVector(0., 0., (beamPipe_Small_Radius_Length-beamPipe_Large_Radius_Length)*0.5), beamPipe_Large_Radius_Logical, "beamPipe_Large_Radius", World_Logical, false, 0);
	...
	new G4PVPlacement(0, global_coordinates+G4ThreeVector(0., 0.,(beamPipe_Small_Radius_Length-exit_Window_Thickness)*0.5), beamPipe_Exit_Window_Logical, "beamPipe_Exit_Window", World_Logical, false, 0);
	...
	new G4PVPlacement(0, global_coordinates+G4ThreeVector(0., 0., 0.), beamPipe_Small_Radius_Logical, "beamPipe_Small_Radius", World_Logical, false, 0);
	...
	new G4PVPlacement(0, global_coordinates+G4ThreeVector(0., 0.,-exit_Window_Thickness), beamPipe_Vacuum_Logical, "beamPipe_Vacuum", World_Logical, false, 0);
