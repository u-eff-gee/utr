...
parser = argparse.ArgumentParser(description='Create an input histogram for Geant4 macros to control the G4GeneralParticleSource which contains the energy spectrum of bremsstrahlung. A model for bremsstrahlung created by an electron beam impinging on a thin target by L.I. Schiff is used.')
...
parser.add_argument('--nbins', metavar='NBINS', type=int, default=1024, help='Number of bins of the spectrum. Note that a histogram for the ')
