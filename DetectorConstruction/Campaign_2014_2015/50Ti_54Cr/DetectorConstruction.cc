...
// This is just a modified geometry of the 82Se - 82Kr experiment from winter
// 2016. The only things that were adapted to the 54Fe - 52Cr - runs are the
// detector positions and the shielding in the second setup.
// TODO:
// 1) Find correct detector positions in terms of angles. At the moment, assume
// arbitrary angles, since for an efficiency simulation, this does not matter.
// 2) Clarify the shielding. Philipp's and Haridas' values differ. Also, don't
// know whether the detectors were wrapped or not (this should not affect the
// efficiency simulation too much)
// 3) Clarify the detector numbering. At the moment, found in the ELOG that
// there are detectors 6 and 7, and that they are called Polarimeter and
// Detector 2. However, it is not clear which is which. By now, assume that the
// Polarimeter is HPGe2_55
...
DetectorConstruction::DetectorConstruction() : world_x(4000. * mm),
                                               world_y(4000. * mm),
                                               world_z(9000. * mm),
...
G4VPhysicalVolume *DetectorConstruction::Construct() {
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 + Wheel_Thickness1 * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 + Wheel_Thickness1 + Wheel_Thickness2 * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 + Wheel_Thickness1 + Wheel_Thickness2 + Wheel_Thickness3 * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 + Wheel_Thickness1 + Wheel_Thickness2 + Wheel_Thickness3 + Wheel_Thickness4 * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 + Wheel_Thickness1 + Wheel_Thickness2 + Wheel_Thickness3 + Wheel_Thickness4 + Wheel_Thickness5 * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall6_To_Target - Wheel_Total_Thickness + Wheel_Thickness0 + Wheel_Thickness1 + Wheel_Thickness2 + Wheel_Thickness3 + Wheel_Thickness4 + Wheel_Thickness5 + Wheel_Thickness6 * 0.5),
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., BeamTube_Length_Downstream - BeamTube_Length / 2.),
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., -BeamTube_Length_Upstream + BeamTubeEndCap_Length / 2.),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., -BeamTube_Length_Upstream - BeamTubeEndCapWindow_Thickness / 2.),
  ...
  new G4PVPlacement(0, G4ThreeVector(0., 0., -ConcreteWall_To_Target - ConcreteWall_Thickness / 2.),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., -BeamTube_Outer_Radius - nb->S * 3. - cb->M - AlPlate_Y * 0.5, -Wall5_To_Target - nb->M * 3 + AlPlate_Z * 0.5),
      AlPlate_Logical, "AlPlate", world_log, false, 0);

  // Concrete Blocks below aluminium plate

  fcb->Put(0., -BeamTube_Outer_Radius - nb->S * 3. - cb->M - AlPlate_Y - fcb->M * 0.5,
           -Wall5_To_Target - nb->M * 3 + fcb->L * 0.5, 0., 0., 90. * deg);
  cb->Put(-fcb->S * 0.5 - cb->M * 0.5, -BeamTube_Outer_Radius - nb->S * 3. - cb->M - AlPlate_Y - cb->M * 0.5,
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., TablePlate_Height - TablePlate_Thickness / 2., Wheel_To_Target_Position + Wheel_Total_Thickness + TablePlate_Length * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Target2_To_Target + Table2_InnerRadius + 50. * mm + PipeHolderTubeDownStream_Length * 0.5),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., Wall7_To_Target + nb->S * 3. + PipeHolderTubeUpStream_Length * 0.5),
  ...
  bb->Put(0., bb->M * 0.5, Wall7_To_Target + nb->S * 3. + PipeHolderTubeUpStream_Length + bb->S * 0.5,
          -90. * deg, 90. * deg, 0.);
  bb->Put(0., bb->M * 0.5, Wall7_To_Target + nb->S * 3. + PipeHolderTubeUpStream_Length + bb->S * 1.5,
          -90. * deg, 90. * deg, 0.);
  ...
  G4UnionSolid *TargetTubeWithCap_Solid = new G4UnionSolid(
      ...
      G4ThreeVector(0., 0., -TargetTubeWithCapBack_Length * 0.5 - TargetTubeWithCapFront_Length * 0.5));
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., BeamTube_Length_Downstream - TargetTubeWithCapBack_Length / 2.),
  ...
  new G4PVPlacement(
      0, G4ThreeVector(0., 0., BeamTube_Length_Downstream + TargetTubeCap_Thickness / 2.),
  ...
  new G4PVPlacement(0,
                    G4ThreeVector(0., 0., -Wall5_To_Target - nb->M * 3. - hsbh->S - LeadFoil_Width * 0.5),
  ...
  new G4PVPlacement(
      rotateG3Target,
      G4ThreeVector(0., 0., -BeamTube_Length_Downstream + BeamTube_Length * 0.5 + se82_Target->Get_Target_Center()),
  ...
  new G4PVPlacement(
      rotateCr2O3_Target,
      G4ThreeVector(0., 0., -BeamTube_Length_Downstream + BeamTube_Length * 0.5 + Target2_To_Target + cr2o3_Target->Get_Target_Center()),
      Cr2O3_Target_Logical, "Cr2O3_Target_Physical", BeamTubeVacuum_Logical,
      false, 0);

  G4cout << "Absolute Target Position"
         << -BeamTube_Length_Downstream + BeamTube_Length * 0.5 +
                Target2_To_Target + cr2o3_Target->Get_Target_Center()
         << G4endl;
...
*/
  ...
  G4double HPGe1_55_AngleX = 0. * deg;
  G4double HPGe1_55_AngleY = 270. * deg;
  ...
  new G4PVPlacement(
      ...
      G4ThreeVector(HPGe1_55_rt * sin(HPGe1_55_theta) * cos(HPGe1_55_phi),
                    ...
                    Target2_To_Target + HPGe1_55_rt * cos(HPGe1_55_theta) +
                        HPGe1_55_dz),
      HPGe1_55_Logical, "HPGe1_55", world_log, false, 0);
  ...
  G4double HPGe2_55_rt = 71. * mm + pb36_64_50->Thickness;
  G4double HPGe2_55_dy = 0. * mm;
  G4double HPGe2_55_dz = 0. * mm;
  G4double HPGe2_55_phi = 90. * deg;
  G4double HPGe2_55_theta = 90. * deg;

  G4double HPGe2_55_AngleX = 270. * deg;
  G4double HPGe2_55_AngleY = 0. * deg;

  HPGe_55_TUNL_21638 *HPGe2_55_Instance = new HPGe_55_TUNL_21638("HPGe2_55");
  G4LogicalVolume *HPGe2_55_Logical = HPGe2_55_Instance->Get_Logical();
  ...
  new G4PVPlacement(
      ...
      G4ThreeVector(HPGe2_55_rt * sin(HPGe2_55_theta) * cos(HPGe2_55_phi),
                    ...
                    Target2_To_Target + HPGe2_55_rt * cos(HPGe2_55_theta) +
                        HPGe2_55_dz),
      HPGe2_55_Logical, "HPGe2_55", world_log, false, 0);
  ...
  // cuthin50
  // HPGe2_55_rt -= cuthin50->Thickness * 0.5;
  // cuthin50->Put(
  //    HPGe2_55_rt * sin(HPGe2_55_theta) * cos(HPGe2_55_phi),
  //    HPGe2_55_rt * sin(HPGe2_55_theta) *
  //            sin(HPGe2_55_phi) +
  //        HPGe2_55_dy,
  //    Target2_To_Target + HPGe2_55_rt * cos(HPGe2_55_theta) +
  //        HPGe2_55_dz,
  ...
  // Pb 50mm, 36/64in
  HPGe2_55_rt -= pb36_64_50->Thickness * 0.5;
  pb36_64_50->Put(
      HPGe2_55_rt * sin(HPGe2_55_theta) * cos(HPGe2_55_phi),
  ...
  /************************* HPGe8 (Germanium2_TUD)
   * *********************************/

  G4double Germanium2_TUD_rt = 75. * mm + cuthin50->Thickness;
  G4double Germanium2_TUD_dy = 0. * mm;
  G4double Germanium2_TUD_dz = 0. * mm;
  G4double Germanium2_TUD_phi = 0. * deg;
  G4double Germanium2_TUD_theta = 90. * deg;

  G4double Germanium2_TUD_AngleX = 0. * deg;
  G4double Germanium2_TUD_AngleY = 90. * deg;
  ...
  G4double Germanium2_TUD_Wrapping_Thickness = 2 * 0.050 * inch;
  // Measured
  ...
  // Pb 50mm, 36/64in
  Germanium2_TUD_rt -= pb36_64_50->Thickness * 0.5;
  pb36_64_50->Put(
      Germanium2_TUD_rt * sin(Germanium2_TUD_theta) * cos(Germanium2_TUD_phi),
      Germanium2_TUD_rt * sin(Germanium2_TUD_theta) *
              sin(Germanium2_TUD_phi) +
  ...
  G4double Polarimeter_TUD_rt = 75. * mm + cuthin50->Thickness;
  ...
  G4double Polarimeter_TUD_Wrapping_Thickness = 2 * 0.050 * inch;
  // Measured
  ...
  // Pb 50mm, 36/64in
  Polarimeter_TUD_rt -= pb36_64_50->Thickness * 0.5;
  pb36_64_50->Put(Polarimeter_TUD_rt * sin(Polarimeter_TUD_theta) *
                      cos(Polarimeter_TUD_phi),
                  Polarimeter_TUD_rt * sin(Polarimeter_TUD_theta) *
                          sin(Polarimeter_TUD_phi) +
                      Polarimeter_TUD_dy,
