...
#include "Detectors_2nd_Setup_9.hh"
#include "HPGe_Coaxial.hh"
#include "HPGe_Collection.hh"
#include "Units.hh"

Detectors_2nd_Setup_9::Detectors_2nd_Setup_9(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_2nd_Setup_9::Construct(G4ThreeVector global_coordinates) {
