...
Gd154_Target::Gd154_Target() : World_Logical(nullptr) {}

Gd154_Target::Gd154_Target(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}
...
void Gd154_Target::Construct(G4ThreeVector global_coordinates) {
  ...
  new G4PVPlacement(
      0, global_coordinates + G4ThreeVector(0., 0., (Gd154_Container_OuterHeight - Gd154_Container_CapThickness) * 0.5),
