...
Detectors_G3_Setup_10::Detectors_G3_Setup_10(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_G3_Setup_10::Construct(G4ThreeVector global_coordinates) {
