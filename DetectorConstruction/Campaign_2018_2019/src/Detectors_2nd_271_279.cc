...
Detectors_2nd_271_279::Detectors_2nd_271_279(G4LogicalVolume *World_Log):
World_Logical(World_Log)
{}

void Detectors_2nd_271_279::Construct(G4ThreeVector global_coordinates){

	HPGe_Collection hpge_Collection;

	/**************** HPGE10 HPGe_Cologne *******************/

	G4double hpge10_rt = 114.4 * mm; 
	...
	hpge11.Add_Filter("G4_Pb", (1.*1.2 + 1.*2.)*mm, 50.*mm);
