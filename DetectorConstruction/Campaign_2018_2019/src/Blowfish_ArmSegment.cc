...
void Blowfish_ArmSegment::Construct(G4ThreeVector global_coordinates){
	...
	if( contArmWidth < collar_outer_diam) contArmWidth = collar_outer_diam;
	contArmWidth += 0.1*mm;
	...
	G4Tubs * armSegContTubs
		= new G4Tubs("ArmSegContainerTubs", arm_Rmin, arm_Rmax, contArmWidth/2., 0., delta_angle);
