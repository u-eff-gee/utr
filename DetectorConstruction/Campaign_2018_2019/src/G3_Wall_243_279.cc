...
G3_Wall_243_279::G3_Wall_243_279(G4LogicalVolume *World_Log) : World_Logical(World_Log),
...
void G3_Wall_243_279::Construct(G4ThreeVector global_coordinates) {
  ...
  G4Tubs *Lead_Wrap_Solid = new G4Tubs("Lead_Wrap_Solid", 1. * inch, 1. * inch + 3. * mm, 16. * inch * 0.5, 0., twopi);
  ...
  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., 0., -G3_Wall_Length * 0.5 + Concrete_Base_Hor_Z + 8. * inch), Lead_Wrap_Logical, "Lead_Wrap", World_Logical, false, 0, false);
}
