...
void Detectors_G3_409_489::Construct(G4ThreeVector global_coordinates){
	...
	G4double HPGe1_Pb_Thickness = 0.*1.2*mm;
	...
	G4double HPGe3_Pb_Thickness = 0.*1.2*mm;
	...
	G4double LaBr1_Pb_Thickness = 1.*1.2*mm; 
	...
	G4double LaBr2_Pb_Thickness = 1.*1.2*mm; 
	...
	G4double LaBr3_Cu_Thickness = 1.*1.15*mm; 
	...
	G4double LaBr4_Cu_Thickness = 1.*1.15*mm;
