...
Detectors_2nd_Setup_4::Detectors_2nd_Setup_4(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_2nd_Setup_4::Construct(G4ThreeVector global_coordinates) {

  HPGe_Collection hpge_Collection;

  /**************** HPGE9 HPGe_Stuttgart *******************/

  G4double hpge9_rt = 82.4 * mm;
