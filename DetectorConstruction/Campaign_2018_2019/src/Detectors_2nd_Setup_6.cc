...
#include "Detectors_2nd_Setup_6.hh"
#include "HPGe_Coaxial.hh"
#include "HPGe_Collection.hh"
#include "Units.hh"

Detectors_2nd_Setup_6::Detectors_2nd_Setup_6(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_2nd_Setup_6::Construct(G4ThreeVector global_coordinates) {

  HPGe_Collection hpge_Collection;

  /**************** HPGE9 HPGe_Stuttgart *******************/

  G4double hpge9_rt = 102.4 * mm;
