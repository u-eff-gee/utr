...
#include "Units.hh"
#include "Detectors_2nd_226_249.hh"
#include "HPGe_Coaxial.hh"
#include "HPGe_Collection.hh"

Detectors_2nd_226_249::Detectors_2nd_226_249(G4LogicalVolume *World_Log):
World_Logical(World_Log)
{}

void Detectors_2nd_226_249::Construct(G4ThreeVector global_coordinates){
	...
	hpge10.Add_Filter("G4_Pb", (2.*1.2+1.*2.)*mm, 50.*mm);
	...
	HPGe_Coaxial hpge11(hpge_Collection.HPGe_86_Stuttgart_31120, World_Logical, "HPGe11");
	hpge11.Add_Filter("G4_Cu", 1.*1.15*mm, 50.*mm);
	hpge11.Add_Filter("G4_Pb", (3.*1.2+1.*2.)*mm, 50.*mm);
	hpge11.Add_Wrap("G4_Pb", 1.*1.2*mm);
	hpge11.Construct(global_coordinates + G4ThreeVector(0., hpge11_dy, hpge11_dz),
			hpge11_theta, hpge11_phi, hpge11_rt, false, false, true);
	...
	HPGe_Coaxial hpge12(hpge_Collection.HPGe_55_TUNL_31524, World_Logical, "HPGe12");
	hpge12.Add_Filter("G4_Cu", 1.*1.15*mm, 50.*mm);
	hpge12.Add_Filter("G4_Pb", (2.*1.2 + 1.*2.)*mm, 50.*mm);
	hpge12.Add_Wrap("G4_Pb", 2.*1.2*mm);
	hpge12.Construct(global_coordinates + G4ThreeVector(0., hpge12_dy, hpge12_dz),
			hpge12_theta, hpge12_phi, hpge12_rt, false, false, true);
}
