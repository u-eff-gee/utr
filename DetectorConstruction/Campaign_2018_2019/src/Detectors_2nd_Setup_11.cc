...
Detectors_2nd_Setup_11::Detectors_2nd_Setup_11(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_2nd_Setup_11::Construct(G4ThreeVector global_coordinates) {

  HPGe_Collection hpge_Collection;

  /**************** HPGE9 HPGe_Stuttgart *******************/

  G4double hpge9_rt = 117.4 * mm; // Added radius of beam pipe compared to value given in ELOG
  ...
  G4double hpge12_rt = 75.4 * mm; // Added radius of beam pipe compared to value given in ELOG
