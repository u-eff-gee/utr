...
G3_Wall_318_576::G3_Wall_318_576(G4LogicalVolume *World_Log) : World_Logical(World_Log),
                                                               Lead_Wall_Tunnel_Y(52. * mm), // Estimtated
                                                               Lead_Wall_Base_Y(159. * mm),
                                                               Concrete_Base_Hor_Y(1110. * mm), // Estimated
...
void G3_Wall_318_576::Construct(G4ThreeVector global_coordinates) {
  ...
  G4double Lead_Wall_Tunnel_X = 243. * mm;
  G4double Lead_Wall_Tunnel_Z = 203. * mm;
  ...
  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., 0., -G3_Wall_Length * 0.5 + Lead_Wall_Tunnel_Z * 0.5), Lead_Wall_Tunnel_Logical, "Lead_Wall_Tunnel", World_Logical, false, 0, false);

  G4double Lead_Wall_Base_X = 307. * mm; // Estimated
  G4double Lead_Wall_Base_Z = 203. * mm;
  ...
  G4double Lead_Wall_Top_X = 307. * mm;
  G4double Lead_Wall_Top_Y = 159. * mm;
  G4double Lead_Wall_Top_Z = 203. * mm;
  ...
  G4Tubs *Lead_Wrap_Solid = new G4Tubs("Lead_Wrap_Solid", 1. * inch, 1. * inch + 3. * mm, 190. * mm * 0.5, 0., twopi);
  ...
  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., 0., -G3_Wall_Length * 0.5 + Concrete_Base_Hor_Z + 190. * mm * 0.5), Lead_Wrap_Logical, "Lead_Wrap", World_Logical, false, 0, false);
}
