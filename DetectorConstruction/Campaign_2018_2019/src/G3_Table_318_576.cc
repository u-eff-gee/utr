...
G3_Table_318_576::G3_Table_318_576(G4LogicalVolume *World_Log) : World_Logical(World_Log),
                                                                 G3_Table_Length(36.25 * inch) {}

void G3_Table_318_576::Construct(G4ThreeVector global_coordinates) {
  ...
  G4double Lead_Collimator_Inner_Radius = 26 * mm; // Estimated, but definitely larger than outer radius of beam pipe
  G4double Lead_Collimator_Outer_Radius = 2. * inch;
  G4double Lead_Collimator_Length = 309 * mm;
  ...
  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., 0., -Wall_To_Table_Edge + .5 * Lead_Collimator_Length), Lead_Collimator_Logical, "Lead_Collimator", World_Logical, false, 0, false);

  G4double Concrete_Base_X = (515. + 59. + 10.) * mm;
  G4double Concrete_Base_Y = 93. * mm;
  G4double Concrete_Base_Z = 395. * mm;
  ...
  G4double Plastic_Base_X = (515. + 59. + 10.) * mm;
  G4double Plastic_Base_Y = 25. * mm;
  G4double Plastic_Base_Z = 395. * mm;
  ...
  G4double Upstream_Holder_Y = -(7.2 * inch - Lead_Wall_Y * 0.5 - Concrete_Base_Y - Plastic_Base_Y);
  ...
  G4double Beam_Pipe_Joint_Outer_Radius = 0.5 * 69. * mm;
  G4Box *Upstream_Holder_Hole_Solid = new G4Box("Upstream_Holder_Hole_Solid", Beam_Pipe_Joint_Outer_Radius, Beam_Pipe_Joint_Outer_Radius, Upstream_Holder_Z);
  ...
  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., -Upstream_Holder_Y * 0.5, -G3_Table_Length * 0.5 + 0.8 * inch + Upstream_Holder_Z * 0.5), Upstream_Holder_Logical, "Upstream_Holder", World_Logical, false, 0, false);

  // Upstream beam pipe holder plate
  G4double Upstream_Holder_Plate_Y = 7.6 * inch;
  G4double Upstream_Holder_Plate_Z = 3. * mm;

  G4Box *Upstream_Holder_Plate_Solid = new G4Box("Upstream_Holder_Plate_Solid", Upstream_Holder_X * 0.5, Upstream_Holder_Plate_Y * 0.5, Upstream_Holder_Plate_Z * 0.5);
  G4LogicalVolume *Upstream_Holder_Plate_Logical = new G4LogicalVolume(Upstream_Holder_Plate_Solid, Al, "Upstream_Holder_Plate_Logical");

  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., 1.0 * inch - Lead_Wall_Y * .5 - Concrete_Base_Y - Plastic_Base_Y + 0.5 * Upstream_Holder_Plate_Y, -G3_Table_Length * .5 + 0.8 * inch - Upstream_Holder_Plate_Z * 0.5), Upstream_Holder_Plate_Logical, "Upstream_Holder", World_Logical, false, 0, false);
