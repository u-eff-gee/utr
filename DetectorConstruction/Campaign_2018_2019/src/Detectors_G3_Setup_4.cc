...
Detectors_G3_Setup_4::Detectors_G3_Setup_4(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_G3_Setup_4::Construct(G4ThreeVector global_coordinates) {
