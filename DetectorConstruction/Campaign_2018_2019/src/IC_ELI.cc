...
Materials *materials3 = Materials::Instance();
...
IC_ELI::IC_ELI(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void IC_ELI::Construct(G4ThreeVector global_coordinates) {
  ...
  //***********detector gas*******
  auto detector_gas3 = new G4Tubs("detector_gas3", 0. * mm, 100. * 0.5 * mm, 130.0 * 0.5 * mm, 0., twopi);
  auto detector_gas3_logical = new G4LogicalVolume(detector_gas3, CF4, "detector_gas3_logical");
  new G4PVPlacement(0, global_coordinates, detector_gas3_logical, "detector_gas3_phys", World_Logical, false, 0, false);
  detector_gas3_logical->SetVisAttributes(blue);
