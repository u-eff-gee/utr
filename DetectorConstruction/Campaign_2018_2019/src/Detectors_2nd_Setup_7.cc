...
#include "Detectors_2nd_Setup_7.hh"
#include "HPGe_Coaxial.hh"
#include "HPGe_Collection.hh"
#include "Units.hh"

Detectors_2nd_Setup_7::Detectors_2nd_Setup_7(G4LogicalVolume *World_Log) : World_Logical(World_Log) {}

void Detectors_2nd_Setup_7::Construct(G4ThreeVector global_coordinates) {

  HPGe_Collection hpge_Collection;

  /**************** HPGE9 HPGe_Stuttgart *******************/

  G4double hpge9_rt = 137.4 * mm;
