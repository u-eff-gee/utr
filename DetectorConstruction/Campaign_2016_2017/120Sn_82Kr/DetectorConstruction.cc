...
/*
 * Setup of the 120Sn - 82Kr experiments of the 2016/2017 campaign
 * The geometry is valid for runs 800 - 844
 */
...
G4VPhysicalVolume *DetectorConstruction::Construct() {
	...
	first_UTR_Wall.Construct(G4ThreeVector(0., 0., Wheel_To_Target - First_Setup_To_Wheel - first_Setup.Get_Length() - First_UTR_Wall_To_First_Setup - first_UTR_Wall.Get_Length()*0.));
	...
	g3_Wall.Construct(G4ThreeVector(0., 0., Wheel_To_Target - First_Setup_To_Wheel + 300.*mm));
