...
Beampipe::Beampipe(G4LogicalVolume *World_Log) : World_Logical(World_Log),
...
void Beampipe::Construct(G4ThreeVector global_coordinates, G4double relative_density) {
  ...
  new G4PVPlacement(0, global_coordinates + G4ThreeVector(0., 0., Z_Axis_Offset_Z - Beampipe_Length * 0.5 + BeampipeEndCap_Length * 0.5),
  ...
  new G4PVPlacement(
      0, global_coordinates + G4ThreeVector(0., 0., Z_Axis_Offset_Z - Beampipe_Length * 0.5 - BeampipeEndCapWindow_Thickness * 0.5),
