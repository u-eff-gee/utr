...
G4VPhysicalVolume *DetectorConstruction::Construct() {
  ...
  G4double Collimator_Length = 305. * mm; // Measured
  ...
  new G4PVPlacement(
      rotateG3Target,
      G4ThreeVector(0., 0., -BeamTube_Length_Downstream + BeamTube_Length * 0.5 + nd150_Target->Get_Target_Center()),
  ...
  new G4PVPlacement(
      rotateSecondTarget,
      G4ThreeVector(0., 0., -BeamTube_Length_Downstream + BeamTube_Length * 0.5 + Target2_To_Target + sm152_Target->Get_Target_Center()),
